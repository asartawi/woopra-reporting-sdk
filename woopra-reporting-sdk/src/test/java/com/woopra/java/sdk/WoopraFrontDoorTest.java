...
public class WoopraFrontDoorTest {
	
	@Autowired
	private WoopraFrontdoor woopraFrontdoor;
	
	@Test
	public void testBuildWoopraBasicAuthenticaiton(){
...
//		woopraFrontdoor.buildWoopraBasicAuthenticaiton(params);
	}
